...
if(NOT "/home/redwan/Desktop/moveIT/moveit/src/Ardrone/GUI/jaist_quad_gui/include" STREQUAL "")
  set(jaist_quad_gui_INCLUDE_DIRS "")
  set(_include_dirs "/home/redwan/Desktop/moveIT/moveit/src/Ardrone/GUI/jaist_quad_gui/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'jaist_quad_gui' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/redwan/Desktop/moveIT/moveit/src/Ardrone/GUI/jaist_quad_gui/${idir}'.  Ask the maintainer 'redwan <redwan@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/redwan/Desktop/moveIT/moveit/src/Ardrone/GUI/jaist_quad_gui/devel/lib;/home/redwan/catkin_ws/devel/lib;/home/redwan/Desktop/moveIT/moveit/devel/lib;/opt/ros/hydro/lib)
